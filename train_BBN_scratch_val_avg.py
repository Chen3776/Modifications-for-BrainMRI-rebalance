...
def valid(model, image_encoder, text_encoder, fuseModule, tokenizer, datasets, device, config):
    ...
    for i, sample in enumerate(data_loader):
        ...
        with torch.no_grad():
            ...
            # Collect Pc_pred before adding a mask
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default='/remote-home/pengyichen/baseline_1/CODE/Pretrain/output_dir/output_BBN_scratch_val_avg')
